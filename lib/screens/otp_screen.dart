...
import 'package:bongalo/screens/signup.dart';
...
class OtpScreen extends StatefulWidget {
  ...
  OtpScreen({
    Key key,
    this.title = "We have sent a code to your number.",
    this.subTitle = "Enter the code to verify account.",
    this.otpLength = 4,
          ...
          children: <Widget>[
            Row(
              children: [
                ...
                Text("Resend", style: TextStyle(color: Colors.lightBlue[500]))
              ],
            ),
            Row(
              children: [
  ...
  Widget _otpTextField(int digit) {
    return new Container(
      ...
      decoration: BoxDecoration(
          border: Border.all(width: 2.0, color: widget.titleColor)),
    );
  }
